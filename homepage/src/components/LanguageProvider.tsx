...
const messages = {
  zh: {
    ...
    projects: {
      ...
      visitWebsite: "访问官网",
      workWebsite: "官网",
      workDownloadMac: "下载 Mac 版",
      workDownloadApk: "下载 APK",
      morePrompt: "想了解更多？",
      moreLink: "在 GitHub 上探索我的其他项目",
      downloadApk: "下载 APK",
  ...
  en: {
    ...
    contact: {
      ...
      interests: "Interested in design & UI/UX",
      hobbies: "💗Coding🧑‍💻Cooking🍳Coffee☕️",
      rednote: "Rednote",
      email: "Email",
    },
    metadata: {
      title: "Jazmín's",
      playTitle: "Jazmín's Playground",
    ...
    projects: {
      ...
      workWebsite: "Website",
      workDownloadMac: "Download Mac",
      workDownloadApk: "Download APK",
      morePrompt: "Curious to see more?",
      moreLink: "Explore my other projects on GitHub",
      downloadApk: "Get APK",
